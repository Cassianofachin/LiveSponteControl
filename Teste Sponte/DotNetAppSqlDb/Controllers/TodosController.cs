...
namespace DotNetAppSqlDb.Controllers
{
    public class TodosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Description,CreatedDate,Done,Nome_instrutor," +
            "Email_instrutor,Nome_espectador,CreatedDate_espectador,Email_espectador," +
            "End_instagram,Nome_live,Desc_live,Instrutor_live,Tempo_live,Valor_live")] Todo todo)
        {
